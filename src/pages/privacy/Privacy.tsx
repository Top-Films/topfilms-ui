...
export default function Privacy() {
	return (
		<InformationPageWrapper>
			...
			<h4>Last updated: April 19, 2024</h4>
			<hr />
			...
			<ul>
				...
				<li>
					<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Top Films.</p>
				</li>
				<li>
				...
				<li>
					<p><strong>Website</strong> refers to Top Films, accessible from <a target='_blank' href='https://topfilms.io' rel='noreferrer'>https://topfilms.io</a></p>
				</li>
				<li>
			...
			<ul>
				<li>
					<p>By email: <a href='mailto:support@topfilms.io'>support@topfilms.io</a></p>
				</li>
			</ul>
		</InformationPageWrapper>
	);
